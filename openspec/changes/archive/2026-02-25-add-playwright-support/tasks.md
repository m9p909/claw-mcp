...
- [x] Task 1.2: Create browser package structure
...
- [x] Task 1.3: Define all request/response types
...
- [x] Task 2.1: Implement BrowserManager singleton in `pkg/browser/browser.go`
...
- [x] Task 2.2: Implement browser initialization
...
- [x] Task 2.3: Implement idle timeout mechanism
...
- [x] Task 2.4: Implement resource cleanup
...
- [x] Task 3.1: Implement browser_navigate in `pkg/browser/tools/navigation.go`
...
- [x] Task 3.2: Implement browser_snapshot in `pkg/browser/tools/snapshot.go`
...
- [x] Task 3.3: Implement browser_navigate_back in `pkg/browser/tools/navigation.go`
...
- [x] Task 4.1: Implement browser_click in `pkg/browser/tools/interaction.go`
...
- [x] Task 4.2: Implement browser_hover in `pkg/browser/tools/interaction.go`
...
- [x] Task 5.1: Implement browser_type in `pkg/browser/tools/input.go`
...
- [x] Task 5.2: Implement browser_fill_form in `pkg/browser/tools/input.go`
...
- [x] Task 5.3: Implement browser_select_option in `pkg/browser/tools/input.go`
...
- [x] Task 5.4: Implement browser_press_key in `pkg/browser/tools/input.go`
...
- [x] Task 6.1: Implement browser_wait_for in `pkg/browser/tools/async.go`
...
- [x] Task 6.2: Implement browser_handle_dialog in `pkg/browser/tools/dialogs.go`
...
- [x] Task 7.1: Implement browser_close in `pkg/browser/tools/lifecycle.go`
...
- [x] Task 8.1: Register all tools in MCP server in `internal/server.go`
...
- [x] Task 8.2: Add environment variable support in `pkg/browser/config.go`
...
- [x] Task 9.1: Implement error handling in `pkg/browser/errors.go`
...
- [x] Task 10.1: Manual test navigate + snapshot
  - Start server
...
- [x] Task 10.3: Manual test idle timeout
...
- [x] Task 10.4: Manual test error handling
